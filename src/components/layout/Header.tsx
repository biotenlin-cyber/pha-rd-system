...
export function Header() {
  ...
  return (
    <header className="fixed top-[30px] inset-x-0 z-50 h-11 bg-paper/72 apple-blur border-b border-hairline/60">
      ...
      {mobileOpen && (
        <div className="md:hidden fixed inset-x-0 top-[74px] bottom-0 bg-paper border-t border-hairline overflow-y-auto">
